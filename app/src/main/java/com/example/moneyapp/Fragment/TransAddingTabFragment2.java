 ...
 */
public class TransAddingTabFragment2 extends Fragment implements View.OnClickListener {
    ...
    public TransAddingTabFragment2() {
    ...
    public void onClick(View v) {
        ...
        final TransAddingActivity activity = (TransAddingActivity)getActivity();
